  ...
  return (
    <div className="card mx-auto max-w-xl overflow-hidden border-2 border-sage-500 bg-white p-8 text-center sm:p-10">
      ...
      <div className="my-8 flex items-end justify-center gap-2">
        <span className="font-heading text-6xl font-bold text-teal">0.10</span>
        <span className="mb-2 text-lg font-semibold text-teal">USD / question</span>
      </div>
      <div className="grid grid-cols-2 gap-3 text-left text-sm text-teal/80">
        ...
        <div className="rounded-xl bg-ivory p-4"><strong className="block text-teal">IntaSend</strong>secure checkout</div>
      </div>
